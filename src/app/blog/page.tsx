        ...
        return (
            <div className="posts_container">
                ...
                <div className="paginations mt-8 flex space-x-2 justify-center">
                    <div className="pagination_item w-full text-[#444] cursor-pointer border font-medium text-sm flex items-center justify-center h-10 capitalize hover:bg-[#4ce5a2] hover:text-[#FFF] hover:border-[#4ce5a2] transition ease-in-out duration-300" onClick={loadMore}>view previous</div>
                </div>
            </div>
        );
}
