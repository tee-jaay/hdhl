...
const TagItem = ({ tag }: { tag: TagProps }) => (
    <Link className="tag_item flex items-center space-x-2 border border-gray-200 py-2 px-4" href={`/tags/${tag?.slug}/12`}>
...
const TagsPage = async () => {
    ...
    return (
        <div className="tags_cloud flex flex-wrap space-x-4 space-y-4">
