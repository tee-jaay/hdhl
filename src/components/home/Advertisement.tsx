...
const Advertisement: React.FC<{}> = () => {
    return (
        <section className="md:w-[768px] lg:w-[1024px] dark:text-white flex flex-col items-center justify-center mx-auto h-28 border border-black dark:border-white my-12">
