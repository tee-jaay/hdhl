...
const PostHeaderSection: React.FC<{ slug: string }> = async ({ slug }) => {
    ...
    return (
        <div className="blog_header py-16 bg-[#FBFAFA] dark:bg-[#333] w-full">
            <h2 className="w-full mx-auto text-[#222] dark:text-white text-center sm:text-2xl md:text-3xl lg:text-4xl font-medium tracking-wide sm:line-clamp-2 md:line-clamp-1">{post?.title}</h2>
