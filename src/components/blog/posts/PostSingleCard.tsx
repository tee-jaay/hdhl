...
const PostSingleCard = ({ post }: { post: PostCardProps }) => <div className="post_single shadow-md pb-8">
    ...
    <div className="post_meta px-6">
        ...
        <div className="post_read_more mt-7">
            <Link href={post?.slug} className="capitalize flex items-center text-[#000] border border-[#e2e2e2] py-1 px-2 space-x-2 w-fit hover:text-[#4ce5a2] hover:border-[#4ce5a2] transition ease-in-out duration-300">
