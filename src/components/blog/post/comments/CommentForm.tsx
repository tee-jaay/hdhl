            ...
            <form onSubmit={formik.handleSubmit}>
                ...
                <div className="comment_save_info my-6">
                    <div className="flex space-x-2">
                        <input
                            ...
                            onChange={formik.handleChange}
                        />
                        <div className="font-light laptop:text-sm desktop:text-lg text-[#666] dark:text-[#FEFEFE]">
                ...
                <div className="comment_submit flex">
                    <input
                        ...
                        type="submit"
                        className={`${isBusy ? "cursor-not-allowed bg-[#999]" : "cursor-pointer bg-[#333] hover:bg-[#43A047]"}  text-[#FFF] capitalize w-full py-2 transition ease-in-out duration-200`}
                    />
                </div>
